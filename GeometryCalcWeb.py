...
def cylinderForm():
   if request.method == "POST":
       ...
       return "User TESt1 entered: Radius "+ str(radius) + " and Height: " + str(height) + ". <p>The Volume is: " + str(vol)
...
def sphereForm():
   if request.method == "POST":
       ...
       sa = sphere.surfaceArea(int(radius))
       return "User entered: Radius "+ str(radius) + ". <p>The Volume is: " + str(vol) + ". <p>The surface area is: " + str(sa)
